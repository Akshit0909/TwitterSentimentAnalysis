...
public class MainActivity extends JFrame{
    ...
    public static void main(String[] args)
    {
        ...
        pieDataset.setValue("Wretched",sentimentCount1);
        pieDataset.setValue("Happy",sentimentCount2);
        pieDataset.setValue("Cloud Nine",sentimentCount3);

        JFreeChart chart = ChartFactory.createPieChart("Twitter Sentiment Analysis- Akshit Miglani",pieDataset);

        BufferedImage image = chart.createBufferedImage(1350,700);
        JLabel labelChart = new JLabel();
        labelChart.setIcon(new ImageIcon(image));
